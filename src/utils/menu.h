...
// Parametri: puntatore a prenotazioni (lista per la validazione), settimana (mappa posti), puntatore a studenti_in_aula (lista presenti)
...
// Parametri: settimana (mappa posti), lista_attesa (coda studenti), puntatore a studenti_in_aula (lista presenti)
...
// Parametri: puntatore a prenotazioni, settimana, puntatore a studenti_in_aula, lista_attesa
// Restituisce: la coda aggiornata della lista d'attesa
...
// Parametri: settimana (mappa posti), puntatore a studenti_in_aula (lista presenti da aggiornare), lista_attesa (coda per il subentro)
...
// Parametri: settimana, lista_attesa, puntatore a studenti_in_aula
